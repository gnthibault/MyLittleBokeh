#from https://github.com/bokeh/bokeh/blob/2.0.0/examples/howto/server_embed/tornado_embed.py
...
if __name__ == '__main__':
    ...
    print('Opens Tornado app with embedded Bokeh app http://localhost:5006/')
